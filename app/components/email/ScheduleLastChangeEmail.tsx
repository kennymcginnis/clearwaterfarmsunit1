...
export function ScheduleLastChangeEmail({
	date,
	schedules,
	emailSubject,
}: {
				...
				>
					...
					<E.Row style={{ padding: '20px', paddingBottom: '0' }}>
						<E.Column>
							...
							>
								We recently closed the irrigation schedule that starts on {date}. ***Please note: You are the last
								irrigator on your Ditch. Please do not pull your checks at the end of your scheduled run.
							</E.Heading>
